...
class BloomFilter
{
    ...
    private final HashAlgorithms [] hashFunction=  {new Ketama_Algo_1(),new MurmurHash_Algo_2(),new MurmurHash128_Algo_3()};;
    ...
    private long [] getHashKeyArray(Object obj){
        long[] tmpset = new long[keySize];
        for (int i = 0; i < keySize; i++)
            tmpset[i] = hashFunction[i].hash(obj);
        return tmpset;
    }
}
